...
class UserService {
  static #profileImageDelete = process.cwd() + '/public/user-profile/profile';
  static #backgroundImageDelete = process.cwd() + '/public/user-profile/background';
  ...
  static async update (user, request, protocol, host) {
    ...
    if (userRequest.profileImage) {
      if (userCurrent.profileImage) {
        ...
        await fs.unlink(UserService.#profileImageDelete + "/" + file);
      }
    }
    if (userRequest.backgroundImage) {
      if (userCurrent.backgroundImage) {
        ...
        await fs.unlink(UserService.#backgroundImageDelete + "/" + file);
      }
    }
